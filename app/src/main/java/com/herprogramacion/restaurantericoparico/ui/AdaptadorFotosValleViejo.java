 ...
 */
public class AdaptadorFotosValleViejo extends RecyclerView.Adapter<AdaptadorFotosValleViejo.ViewHolder> {
    ...
    public AdaptadorFotosValleViejo(EscuchaEventosClick escucha) {
        this.escucha = escucha;
    }

    @Override
    public int getItemCount() {
        return FotoValleViejo.FOTOS.size();
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        FotoValleViejo itemActual = FotoValleViejo.FOTOS.get(i);
