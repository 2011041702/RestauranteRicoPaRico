 ...
 */
public class AdaptadorFotosCityTourTacna extends RecyclerView.Adapter<AdaptadorFotosCityTourTacna.ViewHolder> {
    ...
    public AdaptadorFotosCityTourTacna(EscuchaEventosClick escucha) {
